...
from selenium.webdriver.chrome.options import Options #Importamos options de Chrome
import time
chrome_options = Options()
chrome_options.add_argument("--headless") #Esto nos permite correr en segundo plano una automatizacion en chrome.
